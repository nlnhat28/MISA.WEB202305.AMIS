 ...
 * @param {*} value Employee code to check
 * @returns Error message if invalid, null if valid
 */
export const validateEmployeeCode = (label, value) => {
  try {
 ...
 *
 * @param {*} label Name of field to validate
 * @param {*} value Full name to check
 * @returns Error message if invalid, null if valid
 */
export const validateFullName = (label, value) => {
  try {
    if (isNullOrWhiteSpace(value))
      return `${label} ${resources["vn"].cannotEmpty}`;
  } catch (error) {
 ...
 *
 * @param {*} label Name of field to validate
 * @param {*} value Department to check
 * @param {*} selects Department selects
 * @returns Error message if invalid, null if valid
 */
export const validateDepartment = (label, value, selects) => {
  try {
 ...
 * @param {*} label Name of field to validate
 * @param {*} value Department to check
 * @param {*} selects Position selects
 * @returns Error message if invalid, null if valid
 */
export const validatePosition = (label, value, selects) => {
  try {
