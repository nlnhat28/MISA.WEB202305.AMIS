...
namespace MISA.AMIS.CTM.Application.Tests
{
    /// <summary>
    ...
    public class EmployeeDoaminServiceTests
    {
        ...
        private IDepartmentDomainService _departmentDomainService;
        /// <summary>
        /// Resource
        /// </summary>
        /// Created by: nlnhat (24/07/2023)
        ...
        public void SetUp()
        {
            ...
            _departmentDomainService = Substitute.For<IDepartmentDomainService>(); 
        ...
        public void CheckRangeCodeAsync_WrongFormatCode_ThrowException()
        {
            ...
            var expectedUserMsg = $"{_resource["EmployeeCodeFormat"]} {EmployeeConstant.PrefixCode}{_resource["Number"]}";
        ...
        public async Task CheckRangeCodeAsync_OutOfRangeCode_ThrowException()
        {
            ...
            var maxCode = 1000;
            var limitCode = maxCode + EmployeeConstant.OffsetCode;
